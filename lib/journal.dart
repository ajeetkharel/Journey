...
class _JournalState extends State<Journal> {
  ...
  void initState() {
    ...
    if (widget.journalId == '') {
      ...
      String journalC = widget.prefs.getString("${widget.journalId}.content") ?? '';
      List<Map<String, dynamic>> content;
      try {
        content = journalC.isNotEmpty ? List<Map<String, dynamic>>.from(jsonDecode(journalC)) : Document().toDelta().toJson();
      } catch (e) {
      ...
      setState(() {
        journalTitle = widget.prefs.getString("${widget.journalId}.title") ?? 'Untitled Journal';
        ...
        title: Row(
          children: [
              Padding(
                ...
                child: IconButton(
                  icon: Icon( !_isReadOnly ? Icons.check_rounded : Icons.arrow_back_rounded,
                      color: const Color(0xFFB0BEC5), size: 25),
                  onPressed: () {
                    if (_isReadOnly) {
            ...
            : Padding(
              ...
              child: PopupMenuButton<String>(
                icon: const Icon(Icons.more_vert, color: Color(0xFFB0BEC5), size: 25),
                onSelected: (String result) {
                  if (result == 'Delete') {
                    ...
                    widget.prefs.setStringList('journeyList', journeyList);
                    Navigator.pop(context, true);
                  }
                },
                ...
                buttonOptions: const QuillSimpleToolbarButtonOptions(
                  base: QuillToolbarBaseButtonOptions(
                    ...
                    iconTheme: QuillIconTheme(
                      iconButtonSelectedData: IconButtonData(color: Color.fromARGB(255, 253, 254, 255,), style: ButtonStyle(
                        backgroundColor: MaterialStatePropertyAll(Color.fromARGB(255, 32, 88, 114)),
                      )),
                      iconButtonUnselectedData: IconButtonData(color: Color.fromARGB(255, 32, 88, 114)),
                    )
                  ),
